...
function Contact() {
  return (
    <div className="w-full overflow-x-hidden">
      ...
      >
        <div className="absolute inset-0 bg-blue-800 bg-opacity-50 flex flex-col justify-center items-start p-6 md:p-16">
      ...
      <div className="bg-white py-12">
        <div className="container mx-auto p-4 md:p-6 lg:p-8">
          <div className="bg-blue-900 text-white p-8 md:p-12 rounded-lg">
                ...
                <form className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input
                      ...
                      className="p-3 rounded-lg w-full bg-gray-100 text-gray-900"
                    />
                    <input
                      type="email"
                      placeholder="Email"
                  ...
                  <button
                    type="submit"
                    className="bg-yellow-500 text-blue-900 px-6 py-2 rounded-full shadow-md hover:bg-yellow-600 transition-colors duration-300"
                  >
                    Submit
                  </button>
                </form>
