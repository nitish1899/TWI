    ...
    return (
        <div className="bg-cover bg-center h-screen flex justify-center items-center" style={{ backgroundImage: "url('https://example.com/your-image.jpg')" }}>
            <div className="bg-black bg-opacity-60 p-8 md:p-16 rounded-lg text-center text-white">
                <h1 className="text-3xl md:text-5xl font-bold">Dream Luxottica</h1>
                <p className="text-lg md:text-2xl mt-4">
                    Dream Luxottica is a hospitality company which is
                    opening a 5 star resort in Kedarnath and further plan to develop such
                    resorts in religious places like Kedarnath Dham, Ujjain, Ayodhya,
                    Amarnath Dham.
                </p>
